...
/**
 * Created by sophia on 2017-02-13.
 */
public class TaxModel {
    ...
    public String getCPP()
    {
        ...
        return String.format("%,.0f",this.cpp);
    }
    ...
    public String getEI()
    {
        ...
        return String.format("%.0f",this.ei);
    }
